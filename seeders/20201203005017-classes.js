...
module.exports = {
  ...
  return queryInterface.bulkInsert('classes', [{
    ...
    equipment: "You start with the following equipment, in addition to the equipment granted by your background: (*a*) a greataxe or (*b*) any martial melee weapon, (*a*) two handaxes or (*b*) any simple weapon, An explorer's pack and four javelins",
  ...
  }, 
  {
    ...
    equipment:"You start with the following equipment, in addition to the equipment granted by your background: (*a*) a shortsword or (*b*) any simple weapon, (*a*) a dungeoneer's pack or (*b*) an explorer's pack, 10 darts" ,
    spellcastingAbil: "None",
    createdAt: new Date(),
    updatedAt: new Date(),
  }, 
  ...
  }, 
  {
    ...
    equipment: "You start with the following equipment, in addition to the equipment granted by your background: (*a*) a rapier or (*b*) a shortsword, (*a*) a shortbow and quiver of 20 arrows or (*b*) a shortsword, (*a*) a burglar's pack, (*b*) a dungeoneer's pack, or (*c*) an explorer's pack, (*a*) Leather armor, two daggers, and thieves' tools",
    spellcastingAbil: "None",
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  ...
  },
  {
    ...
    equipment: "You start with the following equipment, in addition to the equipment granted by your background: *(a)* a light crossbow and 20 bolts or (*b*) any simple weapon, *(a)* a component pouch or (*b*) an arcane focus, *(a)* a scholar's pack or (*b*) a dungeoneer's pack, Leather armor, any simple weapon, and two daggers",
    spellcastingAbil: "Charisma",
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
    ...
    equipment:"You start with the following equipment, in addition to the equipment granted by your background: *(a)* a quarterstaff or (*b*) a dagger, *(a)* a component pouch or (*b*) an arcane focus, *(a)* a scholar's pack or (*b*) an explorer's pack, A spellbook" ,
