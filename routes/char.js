...
router.get('/create', async (req, res) => {
    ...
    //         objInfo.sumValueOne = sumValueOne
    ...
    //         objInfo.sumValueTwo = sumValueTwo
    ...
    //         objInfo.sumValueThree = sumValueThree
    ...
    //         objInfo.sumValueFour = sumValueFour
    ...
    //         objInfo.sumValueFive = sumValueFive
    ...
    //         objInfo.sumValueSix = sumValueSix
            ...
            db.classes.findAll().then(classes => {
                ...
                db.race.findAll().then(races => {
                    ...
                    db.background.findAll().then(backgrounds => {
                        let allBackgrounds = backgrounds
